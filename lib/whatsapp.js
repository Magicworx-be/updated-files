...
//
// Bron: data/whatsapp.json. Dat bestand wordt uit TWEE kanalen gevuld: de
// (private) Google Sheet waarin Olivier de doorgegeven nummers bijhoudt, en
// de antwoorden die bedrijven per mail sturen. Omdat de build alleen dit
// lokale bestand leest, kan er nooit een build mislukken omdat Google
// onbereikbaar is.
//
// Een regel die uit een mail komt draagt "bron": "mail". Dat veld doet in deze
// module niets, maar is wel bindend voor wie het bestand bijwerkt: bij het
// opnieuw inlezen van de Sheet is die Sheet alleen de baas over regels ZONDER
// dat veld. Gooi een mailregel dus nooit weg omdat ze niet in de Sheet staat.
//
