...
if (!TOKEN || !REPO) {
  console.error('⚠  GITHUB_SITE_REPO niet ingesteld in .env — site NIET gepubliceerd.');
  console.error('   Vul .env aan en draai opnieuw: node lib/push-site.js');
  // Exitcode 1, niet 0. Dit pad dateert van vóór de site-repo ("zet de variabele
  // pas als de host klaarstaat"). De host staat er nu; een ontbrekende variabele
  // betekent dat er niets live ging, en dat mag niet als succes doorgaan.
  process.exit(1);
}
