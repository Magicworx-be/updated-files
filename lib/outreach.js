...
module.exports = {
  ANTWOORDSOORTEN, STAPPEN, TOP_N, WACHT_WERKDAGEN,
  norm, sleutelVan, legeRij, pad, domeinVan, lokaleDatum, lokaleTijd, vandaagISO,
  load, schrijf, index,
  werkdagenTussen, magBenaderen, magMail1, alOpgevolgd, opvolgKandidaten, wachtOpNummer, wachtOpOlivier, badgeBeloofd,
  dubbeleAdressen,
};
