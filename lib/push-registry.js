...
(async () => {
  ...
  // Exitcode 2 = de push naar GitHub is WEL gelukt, maar jsDelivr serveert nog
  // niet alle pagina's. build-all.js maakt daar een ander (en juist) advies van
  // dan bij een echt mislukte push (exitcode 1).
  if (!cdnOk) process.exitCode = 2;
})();
